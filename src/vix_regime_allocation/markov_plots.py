"""VIX-level figure colored by quantile Markov states."""
...
def plot_markov_vix_states(
    ...
    """Write the canonical two-panel VIX/Markov-state figure."""
    _validate_vix(vix)
    ...
    for axis, states, n_states in zip(axes, (states_2, states_3), (2, 3), strict=True):
        ...
        axis.set_title(f"VIX level colored by Markov quantile state (K={n_states})")
